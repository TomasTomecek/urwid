...
Name:          python-%{srcname}
Version:       release.2.1.0.9.gf27d022
Release:       9%{?dist}
Summary:       Console user interface library

License:       LGPLv2+
URL:           http://excess.org/urwid/
Source0:       urwid-release.2.1.0.9.gf27d022.tar.gz
...
%prep
%setup -q -n urwid-release.2.1.0.9.gf27d022
...
%changelog
* Fri Jan 10 2020 Tomas Tomecek <ttomecek@redhat.com> - release.2.1.0.9.gf27d022-9
Development snapshot (f27d0227)

* Fri Jan 10 2020 Tomas Tomecek <ttomecek@redhat.com> - release.1.3.1.23.g9a29c4e-9
Development snapshot (9a29c4eb)
